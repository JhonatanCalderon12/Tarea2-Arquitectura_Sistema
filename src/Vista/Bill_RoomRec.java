...
public class Bill_RoomRec extends javax.swing.JFrame {
    ...
    private void Get_Data(){
         try{
                String sql="Select BillNo as 'No. Factura.',patientregistration.PatientID as 'ID Paciente',patientregistration.PatientName as 'Nombre Paciente',patientregistration.Gen as 'Genero',patientregistration.BG as 'Grupo Sanguíneo',Disease,AdmitDate as 'Fecha Admisión',room.roomNo as 'No Habitación',doctor.doctorID as 'ID Doctor',doctorName as 'Nombre Doctor',DischargeDate as 'Fecha de Alta',bill_room.roomCharges as 'Cargos Habitación',bill_room.ServiceCharges as 'Cargo Servicios',bill_room.BillingDate as 'Fecha Factura',PaymentMode as 'Modo de Pago',PaymentModeDetails as 'Detalles modo de Pago',TotalCharges as 'Total cargos',NoOfDays as 'No. de Dias',TotalroomCharges as 'Total cargos Habitación' from room,doctor,patientregistration,admitpatient_room,dischargepatient_room,bill_room where room.roomNo=admitpatient_room.roomNo and doctor.doctorID=admitpatient_room.doctorID and patientregistration.PatientID=admitpatient_room.PatientID  and admitpatient_room.PatientID= dischargepatient_room.admitID and bill_room.DischargeID=dischargepatient_room.AdmitID  order by BillNo"; 
