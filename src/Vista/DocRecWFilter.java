...
private void Get_Data(){
      String sql="select doctorID as 'ID Doctor', doctorName as 'Nombre Doctor',FatherName as 'Nombre Padre',Address as 'Dirección' ,ContacNo as 'No Contacto',Email as 'Correo',Qualifications as 'Especializacion',Gender as 'Genero',BloodGroup as 'Grupo Sanguíneo',DateOfJoining as 'Fecha Ingreso' from doctor order by doctorID";        
      try{
