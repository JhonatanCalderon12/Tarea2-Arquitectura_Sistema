...
public class Patient_Discharge_roomRec1 extends javax.swing.JFrame {
 ...
 private void Get_Data(){
         try{
         String sql="Select patientregistration.PatientID as 'ID Paciente',patientregistration.PatientName as 'Nombre Paciente',patientregistration.Gen as 'Genero',patientregistration.BG as 'Grupo Sanguíneo',Disease as 'Enfermedad',AdmitDate as 'Fecha Admisión',room.roomNo as 'No. Habitación',doctor.doctorID as 'ID Doctor',doctorName as 'Nombre Doctor',DischargeDate as 'Fecha de Alta',DP_Remarks as 'Observaciones' from room,doctor,patientregistration,admitpatient_room,dischargepatient_room where room.roomNo=admitpatient_room.roomNo and doctor.doctorID=admitpatient_room.doctorID and patientregistration.PatientID=admitpatient_room.PatientID  and admitpatient_room.PatientID= dischargepatient_room.admitID order by Dischargedate";
