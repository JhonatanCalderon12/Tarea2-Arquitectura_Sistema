...
PreparedStatement pst=null;
 ...
 private void Get_Data(){
         String sql="Select patientregistration.PatientID as 'ID Paciente',patientregistration.PatientName as 'Nombre Paciente',patientregistration.Gen as 'Genero',patientregistration.BG as 'Grupo Sanguineo',Disease as 'Enfermedad',AdmitDate as 'Fecha Admision',room.roomNo as 'No habitacion',doctor.doctorID as 'ID Doctor',doctorName as 'Nombre Doctor',admitpatient_room.AP_Remarks as 'Observaciones' from room,doctor,patientregistration,admitpatient_room where room.roomNo=admitpatient_room.roomNo and doctor.doctorID=admitpatient_room.doctorID and patientregistration.PatientID=admitpatient_room.PatientID order by admitdate";
         try{
